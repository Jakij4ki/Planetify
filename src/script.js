...
// ==== FITUR KUIS EDUKATIF (bisa diulang & random pertanyaan) ====

// Bank soal (lebih banyak pertanyaan)
const allQuestions = [
  { q: "Planet terbesar di tata surya adalah...", a: "Jupiter", options: ["Mars", "Bumi", "Jupiter", "Saturnus"] },
  { q: "Planet terdekat dengan Matahari adalah...", a: "Merkurius", options: ["Venus", "Mars", "Merkurius", "Bumi"] },
  { q: "Planet yang dikenal sebagai planet merah adalah...", a: "Mars", options: ["Mars", "Saturnus", "Neptunus", "Venus"] },
  { q: "Bulan adalah satelit alami dari...", a: "Bumi", options: ["Mars", "Bumi", "Jupiter", "Saturnus"] },
  { q: "Planet terjauh dari Matahari adalah...", a: "Neptunus", options: ["Uranus", "Neptunus", "Pluto", "Saturnus"] },
  { q: "Planet yang memiliki cincin paling indah adalah...", a: "Saturnus", options: ["Uranus", "Jupiter", "Saturnus", "Neptunus"] },
  { q: "Planet yang disebut kembaran Bumi adalah...", a: "Venus", options: ["Mars", "Venus", "Merkurius", "Saturnus"] },
  { q: "Planet yang memiliki rotasi paling cepat adalah...", a: "Jupiter", options: ["Mars", "Jupiter", "Saturnus", "Bumi"] },
  { q: "Planet berwarna biru pucat dan berputar miring ke samping adalah...", a: "Uranus", options: ["Neptunus", "Uranus", "Bumi", "Venus"] },
  { q: "Planet yang tidak memiliki bulan adalah...", a: "Venus", options: ["Venus", "Mars", "Bumi", "Jupiter"] },
  { q: "Planet yang dulunya dianggap planet kesembilan adalah...", a: "Pluto", options: ["Pluto", "Neptunus", "Eris", "Ceres"] },
  { q: "Planet yang memiliki badai besar bernama Great Red Spot adalah...", a: "Jupiter", options: ["Jupiter", "Saturnus", "Mars", "Venus"] },
  { q: "Planet dengan suhu paling panas adalah...", a: "Venus", options: ["Merkurius", "Mars", "Venus", "Bumi"] },
  { q: "Planet yang memiliki hari lebih panjang dari tahunnya adalah...", a: "Venus", options: ["Mars", "Venus", "Bumi", "Merkurius"] },
  { q: "Planet yang memiliki paling banyak bulan adalah...", a: "Saturnus", options: ["Jupiter", "Uranus", "Saturnus", "Neptunus"] }
];
...
function startQuiz() {
  ...
  currentQ = 0;
  result.textContent = "";
  questions = shuffleArray([...allQuestions]).slice(0, 5); // ambil 5 pertanyaan acak
  loadQuestion();
}
...
function loadQuestion() {
  ...
  quizContainer.innerHTML = `
    ...
    ${shuffleArray(q.options)
      .map(opt => `<button class="opt-btn">${opt}</button>`)
      .join("")}
  `;
...
function showResult() {
  quizContainer.innerHTML = "";
  result.innerHTML = `
    🎉 Kuis selesai! Skor kamu: <b>${score}/${questions.length}</b><br><br>
...
// === Integrasi GUI dengan Panel Kuis ===

// Ambil elemen panel kuis
const quizPanel = document.getElementById("quiz-panel");

// Tambahkan properti ke settings
settings.showQuiz = true;

// Tambahkan kontrol ke GUI
gui.add(settings, "showQuiz").name("Tampilkan Kuis").onChange(value => {
  if (value) {
